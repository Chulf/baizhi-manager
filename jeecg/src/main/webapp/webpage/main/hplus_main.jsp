...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <%--dangzhenghui begin 20170502 for 增加添加头像功能--%>
                                <span><img alt="image" width="180" height="61" src="${pageContext.request.contextPath}/plug-in/login/images/baizhi.png" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用后台管理系统" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right"><a href="http://mainriversoft.com/baizhiweb" target="_blank">mainriversoft.com/baizhiweb</a>
            </div>
        </div>        
