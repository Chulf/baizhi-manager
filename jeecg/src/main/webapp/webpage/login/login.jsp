        ...
        <div class="login-container">
          <div class="center">
            <h1 id="id-text2" class="grey">
              ...
              <img src="${pageContext.request.contextPath}/images/baizhi.png"/>
               后台管理系统
            </h1>
            <h4 class="blue" id="id-company-text">mainriversoft.com/baizhiweb</h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <%--<div class="center"><h4 class="blue" id="id-company-text">&copy; 百知教育版权所有 </h4></div>--%>
