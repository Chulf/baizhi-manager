...
(function(){
	if($.Datatype){
		$.extend($.Tipmsg.w,{
			...
			"zh":"Plase enter chinese!",
			"dword":"Please enter double byte character!",
			"money":"Please enter currency value!",
			"ipv4":"Please enter IP address!",
			"ipv6":"Plese enter IPv6 address!",
			"num":"Please enter numeric value!",
			"qq":"Please enter QQ number!",
			"unequal":"Value can not equal!",
			"notvalued":"Cannot contain a specific value!",
			"idcard":"Identity card number wrong!"
		});
			...
			*/
			...
			"min":function(gets,obj,curform,datatype){
				...
				*/
				...
				return  numselected >= minim ? true : "Please only select "+minim+"item!";
			},
			...
			"max":function(gets,obj,curform,datatype){
				...
				*/
				...
				if(numselected==0){
					...
					return "You can only select "+atmax+" item!";
				}
				return  true;
			},
			...
			"byterange":function(gets,obj,curform,datatype){
				...
				*/
				...
				if(getslen>maxim){
					return "Input character cannot be more than "+maxim+", chinese counts as two characters!";
				}
				
				if(getslen<minim){
					return "Input character cannot be less than "+minim+", chinese counts as two characters!";
				}
			...
			"numrange":function(gets,obj,curform,datatype){
				...
				*/
				...
				if(gets<minim){
					return "value can not less than "+minim+"!";
				}else if(gets>maxim){
					return "value can not more than "+maxim+"!";
				}
				return  true;
			},
			...
			"daterange":function(gets,obj,curform,datatype){
				...
				*/
				...
				if(gets>maxim){
					return "The date cannot be greater than "+obj.attr("max");	
				}
				
				if(gets<minim){
					return "The date cannot be less than "+obj.attr("min");
				}
